...
class ProductJob implements ShouldQueue
{
    ...
    protected $filename;
        ...
        //karena dispatch mengirim 2 parameter
        //maka kita terima kedua data tsb
    ...
    public function handle()
    {
        ...
        $files = (new ProductImport)->toArray(storage_path('app/public/uploads/' . $this->filname));

      	//KEMUDIAN LOOPING DATANYA        foreach($files[0] as $row) {
