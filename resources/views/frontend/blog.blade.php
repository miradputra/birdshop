                        ...
                        <div class="blog_details">
                            ...
                            <p>It is a long established fact that a reader will be distracted by the readable content
                             ...
                             of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop
                              publishing packages and web page editors now use Lorem Ipsum as. <a href="single-blog" class="blog_btn">Selengkapnya ...</a></p>
                        </div>
                      </article>
                      <article class="blog_item">
                        <div class="blog_item_img">
                          <img class="card-img rounded-0" src="frontend/eiser/img/blog/main-blog/info2.jpg" alt="">
                        </div>
                        <div class="blog_details">
                            <a class="d-inline-block" href="single-blog.html">
                                <h2>Info Lomba burung</h2>
                            ...
                            Ipsum as . <a href="single-blog" class="blog_btn">Selengkapnya ...</a></p>
                        </div>
                      </article>  
